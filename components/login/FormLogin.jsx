...
export default function Login() {
    const { formData, notification, handleChange, handleSubmit, clearNotification } = useLogin();
                                ...
                                <div className="flex items-center justify-between">
                                    <div className="flex items-center">
                                        <input
                                            ...
                                            onChange={handleChange}
                                            className="w-4 h-4 text-blue-600 border-gray-300 rounded focus:ring-blue-500 dark:bg-zinc-700"
                                        />
                                        <label htmlFor="remember-me" className="block ml-2 text-sm text-gray-600 dark:text-gray-300">
                                            Remember me
                                        </label>
                                    </div>
                                    ...
                                    <div className="text-sm">
                                        <Link
                                            ...
                                            className="font-medium text-purple-600 hover:text-purple-500 dark:text-purple-800 dark:hover:text-purple-700"
                                        >
